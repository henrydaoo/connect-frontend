          ...
          <div className="relative bg-brand rounded-3xl overflow-hidden min-h-[400px] flex items-center justify-center">
            ...
            <div className="text-center space-y-8 px-8 relative z-10">
              ...
              <p className="text-xl text-white/90 max-w-2xl mx-auto">
                Whether You&apos;re Finding A Developer Or A Full Team
                Connection, Connect Makes It Simple, Fast, Secure, And With No
                Card Fees To Worry About.
              </p>

              <Button
                variant="outline"
                size="lg"
                className="text-white border-white/30 hover:bg-white hover:text-brand bg-transparent px-8 py-3 rounded-full"
              >
                Explore More →
              </Button>
            </div>
